...
def create_sequential(self, input_length, output_length, layer_size, blow: int | float = 0, shrink_factor="log", activation_function=nn.ReLU(), last_activation=None, batch_norm=False, layer_norm=False):
    layers = [input_length]
